 ...
 */
export function searchVideos(query, append = false) {
    ...
    let requestUrl = `${BASE_URL}?part=snippet&type=video&maxResults=5&q=${encodeURIComponent(query)}&key=${API_KEY}`;
    if (nextPageToken) {
 ...
 */
export function autoPlayPlaylist(query) {
